...
function displayOrder(){
	...
	let totalLeftRounded = Math.round(totalLeft * 100) / 100;
	if(totalLeftRounded <= 0){
		submit.disabled = false;
	}else{
		totalPrice.innerHTML += "You must add $" + totalLeftRounded + " more to your order before submitting" + "<br/>";
	}
