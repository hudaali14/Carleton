...
function displayItems(restaurantIndex, categoryName){
	let itemMenu = document.getElementById("items");
	//console.log(JSON.stringify(categoryName));
	let categoryItems = restaurants[restaurantIndex].menu[JSON.stringify(categoryName)];
	console.log(categoryItems[0].name);
	if(categoryItems){
