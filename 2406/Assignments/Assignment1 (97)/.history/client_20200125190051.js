...
function displayItems(restaurant, categoryName){
	let itemMenu = document.getElementById("items");
	//console.log(JSON.stringify(categoryName));
	let categoryItems = restaurant.menu[JSON.stringify(categoryName)];
