...
function init(){
	...
	r.onchange = displayRestaurant(r.selectedIndex);
}
...
function displayRestaurant(index){
	...
	para.innerHTML = restaurants[index].name;
	para.innerHTML = restaurants[index].min_order;
	para.innerHTML = restaurants[index].delivery_charge;
