...
function displayOrder(restaurant){
	...
	let totalUnitPriceRounded = 0;

	// Event listener for when button is clicked
	submit.addEventListener("click", requestSubmitOrder(totalUnitPriceRounded));
	...
	order.forEach(element =>{
		...
		totalUnitPriceRounded = Math.round((element.amount* element.price) * 100) / 100;
