...
function init(){
	...
	let txt = "#" + element;
	para.href = "#home";
	home.innerHTML = "Home Page" + "<br/>";
	let orderform = document.createElement("a");
	orderform.innerHTML = "Order Form" + "<br/>";
	let stats = document.createElement("a");
	stats.innerHTML = "Restaurant Stats Page" + "<br/>";
	header.appendChild(home);
	header.appendChild(orderform);
