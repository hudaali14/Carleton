...
void Control::initStudents(){
    ...
    Student* stu3 = new Student("101010101", "Jeon Jungkook" , "Art", 11.5f);
    Student* stu4 = new Student("101010101", "Min Yoongi" , "Food Science", 10.5f);
    Student* stu5 = new Student("101010101", "Kim Namjoon" , "Math", 12.0f);
    Student* stu6 = new Student("101010101", "Kim Seokjin" , "Psychology", 10.0f);
    Student* stu7 = new Student("101010101", "Jung Hoseok" , "Chemistry", 10.0f);
